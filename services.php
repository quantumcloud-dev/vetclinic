				...
				<div class="content text-center">
					...
					<div class="col-sm-4">
						...
						<?php
							...
							if(isset($_SESSION['consultationSuccess'])){
								echo "
								...
								".$_SESSION['consultationSuccess']."
							</div>
								";
								unset($_SESSION['consultationSuccess']);
							}
						?>
						...
						<div class="row">
							<div class="col-md-12"> 
								<div class="panel bg-gray">
									<i><h3>Consultation</h3></i><hr>
									<div class="panel-body">
									<!--/stories-->
									<div class="row">    
										
										<img src="images/consultation.jpg" style="width:88%; height:auto;" alt="" srcset="">									
										</div>
									<hr>
									<a href="#consultation" data-toggle="modal" 
                    ...
                    <div class="col-sm-4">
						<?php
							...
							if(isset($_SESSION['vaccinationSuccess'])){
								echo "
								<div class='alert alert-success alert-dismissible'>
								<button type='button' class='close' data-dismiss='alert' 
									aria-hidden='true'>&times;</button>
								<h4><i class='icon fa fa-check'></i> Success!</h4>
								".$_SESSION['vaccinationSuccess']."
							</div>
								";
								unset($_SESSION['vaccinationSuccess']);
							}
						?>
						<div class="row">
						    <div class="col-md-12"> 
								...
								<hr>
                                   ...
                                   <img src="images/vaccination.jpg" style="width:88%; height:auto;" alt="" srcset="">
                                </div>
                                    <hr>
									<a href="#vaccination" data-toggle="modal" 
									class="btn btn-primary btn-sm btn-flat">
									<i class="fa fa-plus"></i> Add Appointment</a>
                            </div>
						</div>
					...
					<div class="col-sm-4">
						...
						<?php
							...
							if(isset($_SESSION['groomingSuccess'])){
								echo "
								<div class='alert alert-success alert-dismissible'>
								<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
								<h4><i class='icon fa fa-check'></i> Success!</h4>
								".$_SESSION['groomingSuccess']."
							</div>
								";
								unset($_SESSION['groomingSuccess']);
							}
						?>
						...
						<div class="row">
						    <div class="col-md-12"> 
								...
								<hr>
									...
									<img src="images/grooming.jpg" style="width:88%; height:auto;" alt="" srcset="">
                                	</div>
                                    <hr>
									<a href="#grooming" data-toggle="modal" 
									class="btn btn-primary btn-sm btn-flat">
									<i class="fa fa-plus"></i> Add Appointment</a>
                            </div>
						</div>
					...
					<div class="row">
						<div class="col-sm-12 col-md-12 col-lg-12">
							<?php
								...
								if(isset($_SESSION['appDeleteSuccess'])){
									echo "
									<div class='alert alert-success alert-dismissible'>
									<button type='button' class='close' data-dismiss='alert' 
									aria-hidden='true'>&times;</button>
									...
									<h4><i class='icon fa fa-check'></i> Success!</h4>
									".$_SESSION['appDeleteSuccess']."
								</div>
									";
									unset($_SESSION['appDeleteSuccess']);
								}
							?>
							<div class="col-xs-12">
								<div class="box">
									<div class="box-header with-border bg-gray">
										<i><h2>My Requests</h2></i><br>
									</div>
									<div class="box-body">
										<table id="requests" class="table table-bordered table-striped bg-gray" width="100%">
											<thead>
											<style>
												th{
													text-align:center;
											...
											<?php
												...
												foreach($stmt as $row){
													...
													: 'images/profile.jpg';
													echo "
													<tr class='delete' data-id='".$row['request_id']."'>
										...
										<div class="box-body">
											<table id="history" 
												...
												<?php
													...
													where owner_id ='$session_id' order by id DESC");
													$stmt->execute();
													$status ='';
                                                    ...
                                                    foreach($stmt as $row){
                                                      ...
                                                      echo "<tr>
														  ...
														  <td><button href='#historyPet' 
															data-id='".$row['pet_id']."' data-toggle='modal' 
															class='medHistory btn btn-sm btn-primary'>
								...
								<div class="box">
									...
									<style>
										...
										<?php
											...
											try{
											$stmt = $conn->prepare("SELECT * FROM histories 
											where owner_id ='$session_id' order by date DESC");
											$stmt->execute();
	...
	function getRow(id){
		$.ajax({
			...
			success: function(response){
				...
				$('.reqDate').html(response.request_date);
				$('.reqType').html(response.request_type);
				$('.appType').html(response.appointment_type);
